  ...
  return (
    <div className="p-4">
      <div
        ...
        className="rounded-[34px] shadow-2xl mx-4 p-3 my-4 "
      >
        ...
        <div className="grid gap-6 my-8">
          <div className={styles.glass}>
            <h5 className="text-2xl m-1 font-bold text-gray-200">100</h5>
          ...
          <div className={styles.glass}>
            <h5 className="text-2xl m-1 font-bold text-gray-200">
              1.215845848
            </h5>
            <select className="bg-purple-800 text-white text-lg p-2 rounded-lg m-1">
        ...
        <p className="text-xl text-gray-200 font-bold mx-4 my-14 text-center">100 EUR = 0.01098913 BTC</p>
      </div>
      <LivePricing/>
    </div>
  );
